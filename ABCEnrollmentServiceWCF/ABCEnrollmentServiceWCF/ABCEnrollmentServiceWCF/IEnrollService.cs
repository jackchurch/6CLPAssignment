...
{
    // NOTE: You can use the "Rename" command on the "Refactor" menu to change the interface name "IEnrollService" in both code and config file together.
    [ServiceContract]
    public interface IEnrollService
    {
        ...
        [OperationContract]
        List<CourseVO> GetEnrollmentsForStudent(string studentID);
